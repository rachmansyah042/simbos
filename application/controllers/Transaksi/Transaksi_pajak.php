...
class Transaksi_pajak extends CI_Controller {
    ...
    public function index() 
    {
        if( $this->session->userdata('save_token') ==TRUE) {
            ...
            //get setoran
            $url = 'https://deployed.my.id:3000/v1/simbos/operator/getSetoran';
    ...
    public function setor() 
    {
        ...
        $url_setor = 'https://deployed.my.id:3000/v1/simbos/operator/addSetorpajak';
    ...
    public function batal() 
    {
        ...
        $url_batal = 'https://deployed.my.id:3000/v1/simbos/operator/batalsetorpajak';
